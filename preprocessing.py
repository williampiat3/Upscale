...
def remap(folder1,folder2,window=24):
	...
	upscaler = nn.Upsample(size=(1080, 1920), scale_factor=None, mode='nearest', align_corners=None)
	for k,f in enumerate(sorted(onlyfiles_lr)):
		...
		print(f,min_file)
def resize_base():
	path_init="/media/will/227E8A467E8A1329/Users/willi/Documents/Batman/frames/LR"
	...
	reducer = nn.Upsample(size=(540, 960), scale_factor=None, mode='bilinear', align_corners=True)
	for f in tqdm(onlyfiles_lr):
		img = loader(join(path_init, f)).cuda()
		if img.shape[2]!=960 or img.shape[1]!=540:
...
if __name__ == "__main__":
	...
	# remap("/home/will/Dataset/episodes/LRN","/home/will/Dataset/episodes/HRN",window=10)
	# exit()